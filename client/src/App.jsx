...
const App = () => {
  ...
  // console.log("adminjbsdhb",isAdmin);
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/pages/return-and-refund-policy" element={<ReturnAndRefundPolicy />} />
        <Route path="/pages/terms-and-conditions" element={<TermsAndCondition />} />
        <Route path="/*" element={<NotFound />} />
        ...
        <Route path="/admin/products" element={isAdmin ? <Product /> :<NotAcc />} />
        <Route path="/admin/users" element={isAdmin ? <Users /> :<NotAcc />} />
        <Route path="/admin/orders" element={isAdmin ? <Orders /> :<NotAcc />} />
        <Route path="/admin/coupon" element={isAdmin ? <Coupon /> :<NotAcc />} />
      </Routes>
