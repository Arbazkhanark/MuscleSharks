                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="relative p-6 flex-auto">
                    ...
                    <div className="mb-4">
                      ...
                      <input
                        onChange={(e) => setUpdatedProduct({ ...updateProduct, stock: parseInt(e.target.value) })}
                        type="number"
                        id="stock"
                        name="stock"
                        className="w-full border border-blueGray-300 rounded-lg px-3 py-2"
                    ...
                    <div className="mb-4">
                      <label htmlFor="category" className="block text-blueGray-600 text-sm font-bold mb-2">
                        Category
                      </label>
                      <select
                      ...
                      >
                        ...
                        <option value="Amino Acids and BCAAs">Amino Acids and BCAAs</option>
                        <option value="Pre-Workout Supplements">Pre-Workout Supplements</option>
                        <option value="Post-Workout Recovery Supplements">Post-Workout Recovery Supplements</option>
                        <option value="Fat Burners and Weight Loss Supplements">Fat Burners and Weight Loss Supplements</option>
                        <option value="Vitamins and Minerals">Vitamins and Minerals</option>
                      </select>
                    </div>
                    <div className="mb-4">
                      <label htmlFor="description" className="block text-blueGray-600 text-sm font-bold mb-2">
                        Description
                      </label>
                      <textarea
