...
export const placeOrder=(orderData)=>async(dispatch)=>{
    try {
        ...
        const response=await axios.post("http://localhost:5000/orderNow",orderData)
...
export const applyCoupon=(code,amount)=>async(dispatch)=>{
    try {
        ...
        const response=await axios.post("http://localhost:5000/apply-coupon",{couponCode:code,orderAmount:amount});
