...
const SearchBar = ({ setSearchQuery }) => {
  ...
  const handleChange = (e) => {
    ...
    setQuery(value);
    setSearchQuery(value); // Update search query in parent component
  };
      ...
      <form>
        ...
        <div className="relative">
          ...
          <input
            ...
            placeholder="Search for Your Supplement.."
            value={query}
            onChange={handleChange} // Use onChange to handle input changes
            required
          />
          <button
            type="submit"
