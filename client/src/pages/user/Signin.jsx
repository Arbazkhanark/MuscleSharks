...
//     {isLoader ?
//     <Loader />:
//       <div className=" mt-20 mb-20 flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl mt-10">
//         <div
...
//           </div>
//           <div className="mt-6">
//             <button onClick={()=>dispatch(userLogInAction(user,navigate))} className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-amber-400 rounded-lg hover:bg-amber-400 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50">
//               Sign In
//             </button>
//           </div>
